process NORMALISE_and_PCA_PHENOTYPE{
    ...
    script:
        ...
        """  
            normalise_and_pca.R ${phenotype_file} ${grouping_file} ${params.filter_method} ${params.covariates.nr_phenotype_pcs} ${params.norm_method} ${params.percent_op_pop_expressed}
        """
