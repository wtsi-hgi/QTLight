...
bsub -R'select[mem>300] rusage[mem=300]' -J $sample -n 1 -M 300 -o $sample.o -e $sample.e -q $QUEUE bash $SCRIPT_DIR/../../assets/deploy_scripts/nohup_start_nextflow_lsf.sh $INPUT_FILE
