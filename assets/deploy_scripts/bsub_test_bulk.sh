...
bsub -R'select[mem>4000] rusage[mem=4000]' -J QTLight_test -n 1 -M 4000 -o QTLight_test.o -e QTLight_test.e -q normal bash $SCRIPT_DIR/../../assets/deploy_scripts/nohup_start_nextflow_lsf_test_bulk.sh
